...
var _RedBlackBST = __webpack_require__(0);
...
var dictionary = {
  data: new _RedBlackBST.RedBlackBST(),
  wordChain: [],
  getByFirstLetter: function getByFirstLetter(prefix) {
...
(function () {
  ...
  var computer = {
    memory: new _RedBlackBST.RedBlackBST(),
