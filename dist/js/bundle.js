...
exports.default = {
  ...
  removeClass: function removeClass(dom, name) {
    if (!this.containClass(dom, name)) {
      return;
    }
    if (dom.classList) {
  ...
  containClass: function containClass(dom, name) {
    if (dom.classList) {
  ...
  scrollDown: function scrollDown(dom, currentTime, duration) {
...
var _RedBlackBST = __webpack_require__(2);

var _RedBlackBST2 = _interopRequireDefault(_RedBlackBST);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function Dictionary() {
  this.data = new _RedBlackBST2.default();
  initDictionary(this);
}
...
Dictionary.prototype.add = function (word, value) {
  this.data.put(word, value);
};
...
exports.default = {
  ...
  reset: function reset() {
    for (var i = this.wordChain.length - 1; i >= 0; i--) {
      _Dictionary2.default.add(this.wordChain[i], this.wordChain[i]);
    }
    this.wordChain = [];
  },
  ...
  timeStart: function timeStart() {
    var self = this;
    _utils2.default.addClass(this.timerDom.timerWrapper, 'no-animation');
    _utils2.default.removeClass(this.timerDom.timerWrapper, 'paused');
    setTimeout(function () {
      _utils2.default.removeClass(self.timerDom.timerWrapper, 'no-animation');
    }, 20);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--1-1!../../node_modules/postcss-loader/index.js??ref--1-2!./index.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--1-1!../../node_modules/postcss-loader/index.js??ref--1-2!./index.css");
...
(function () {
  ...
  function initGame() {
    ...
    _game2.default.timerDom.timerWrapper = timerWrapper;
    _game2.default.timerDom.num = timerWrapper.querySelector('.num');
    _game2.default.timerDom.left = timerWrapper.querySelector('.left');
    _game2.default.timerDom.right = timerWrapper.querySelector('.right');
    _game2.default.timerDom.rotate = timerWrapper.querySelector('.rotate');
    _game2.default.endModal = document.querySelector('.end-modal');
  ...
  highlighInput: function highlighInput(hasKeyboard) {
    ...
    var callback = hasKeyboard ? function (e) {
      ...
      if (target.getAttribute('id') === 'answer-wrapper') {
        ...
        _utils2.default.removeClass(keyboard, 'hide');
